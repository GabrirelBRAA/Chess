...
class Queen(Piece):
    def __init__(self,number,position,color,board):
        ...
        self.letter="Q" if color=="White" else "q"
    ...
    def find_moves(self):
        ...
        if self.color==0:
            ...
            for x in range(0, 8):
                ...
                if movimento_possivel in self.board.initial_board.keys() and self.board.actual_board[
                    movimento_possivel].color == None:
                    movimentos.append(movimento_possivel)
                elif movimento_possivel in self.board.initial_board.keys() and self.board.actual_board[
                    movimento_possivel].color == 1:
                    movimentos.append(movimento_possivel)
                    break
                elif movimento_possivel in self.board.initial_board.keys() and self.board.actual_board[
                    movimento_possivel].color == 0:
                    break
            ...
            movimento_possivel = self.position
            for x in range(0, 8):
                movimento_possivel = ((movimento_possivel[0] - 1, movimento_possivel[1] + 1))
                if movimento_possivel in self.board.initial_board.keys() and self.board.actual_board[
                    movimento_possivel].color == None:
                    movimentos.append(movimento_possivel)
                elif movimento_possivel in self.board.initial_board.keys() and self.board.actual_board[
